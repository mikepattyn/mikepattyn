...
Research summary for deploying kapsalon, fish, mikepattyn portfolio, Lumen, and alienbutnice from this repository without deploying the full platform.
...
| Lumen | `apps/prompt-engineering` | `Lumen-Frontend-Stack-Production` | `Mikepattyn-Domain-Stack` |
...
| Lumen | `/Lumen/Production/Frontend/BucketName` | `/Lumen/Production/Frontend/DistributionId` |
...
make deploy-lumen                     # frontend stack + static files → S3
```

## CI (root `.github/workflows`)

- **Content:** path-filtered workflows on `main`; kapsalon/fish default to Development; brands and Lumen to Production.
...
flowchart TB
  ...
  LU[Lumen-Frontend-Stack-Production]
